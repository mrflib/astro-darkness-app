...
"""
    ...
    with st.expander("Pick on Map (optional)", expanded=False):
        ...
        # Corrected Assignment for map_result
    ...
    console_placeholder.text_area(
        ...
        height=150,
        max_chars=None,
        key="progress_console_display",  # Use a unique key
        disabled=True,
    ...
    console_placeholder.text_area(
        ...
        height=150,
        max_chars=None,
        key="progress_console_display",  # Ensure this key is unique and only used once
        disabled=True,
        help="Progress Console displaying calculation steps.",
        label_visibility="collapsed"
    )
...
"""
    ...
    # Update the console box with the latest debug messages
    # Since Streamlit doesn't support auto-scrolling, ensuring that the text_area updates correctly
    console_placeholder.text_area(
        "",
        value=st.session_state["progress_console"],
        height=150,
        max_chars=None,
        key="progress_console_display",  # Use the same key consistently
        disabled=True,
        help="Progress Console displaying calculation steps.",
        label_visibility="collapsed"
    )
